...
int64 UDiscordFunctionLibrary::StringToInt64(
...
FString UDiscordFunctionLibrary::Int64ToString(
	const int64& Number
)
{
...
int64 UDiscordFunctionLibrary::TextToInt64(
	const FText& Text
)
{
...
FText UDiscordFunctionLibrary::Int64ToText(
	const int64& Number
)
{
...
UDiscordUser* UDiscordFunctionLibrary::GetCurrentUser(
...
int64 UDiscordFunctionLibrary::GetUnixTimestamp(
